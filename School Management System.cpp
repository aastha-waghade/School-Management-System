    ...
    void searchResult()
    {
        ...
        for (i = 0; i < studentCount; i++)
        {
            if (studentId[i] == studentId2)
            {
                ...
                cout << "Surname: " << studentSurname[i] << endl;
                cout << "Father Name: " << studentFatherName[i] << endl;
    ...
    void editResult()
    {
        ...
        else
        {
            ...
            if (subjectChoice >= 1 && subjectChoice <= 5)
            {
                ...
                if (markChoice == 1)
                {
                    internal[i][subjectChoice - 1] = marks;

                    cout << "Internal Marks Updated Successfully"
                         << endl;
                }
                else if (markChoice == 2)
                {
                    onPaper[i][subjectChoice - 1] = marks;

                    cout << "On Paper Marks Updated Successfully"
                         << endl;
                }
                else
                {
    ...
    void addMarks()
    {
        ...
        else
        {
            ...
            if (subjectChoice >= 1 && subjectChoice <= 5)
            {
                ...
                cout << "Enter On Paper Marks: ";
                cin >> paperMarks;

                internal[i][subjectChoice - 1] = internalMarks;
                onPaper[i][subjectChoice - 1] = paperMarks;
            ...
            case 1:
                ...
                if (uname == username && pass == password)
                {
                    ...
                    do
                    {
                        cout << endl;
                        cout << "----- Teacher Portal -----" << endl;
                        cout << "1. Select Subject / Add Marks" << endl;
        ...
        do
        {
            ...
            case 1:
...

                {
                    ...
                    if (i == studentCount)
                    {
                        cout << "Wrong Student Id Or Password" << endl;
                    }
                    else
                    {
                        cout << "Login Successful" << endl;
